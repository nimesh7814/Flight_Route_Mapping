...
install.packages(c(
  ...
  "rnaturalearthdata", "geosphere", "tmap"
))
```
...
airports_map <- tm_shape(world) + 
  ...
  tm_layout(
    ...
    inner.margins = c(0.02, 0.01, 0.04, 0.02),
...
# Save the map
tmap_save(airports_map, "output/01.airports_map.png", width = 16, height = 10, dpi = 300)
...
# Save the map
tmap_save(world_busiest_airports_map, "output/02.world_busiest_airports_map.png", width = 16, height = 10, dpi = 300)
...
# Save the map
tmap_save(routes_lines_map, "output/03.routes_euclidean_map.png", width = 16, height = 10, dpi = 300)
...
# Save the map
tmap_save(routes_geodetic_map, "output/04.routes_geodetic_map.png", width = 16, height = 10, dpi = 300)
...
map_geodetic <- tm_shape(world) +
  ...
  tm_polygons(
    col = "nm_rts",
    palette = c("#440154", "#31688e", "#35b779", "#fde724"),  # Viridis-inspired gradient
    style = "fixed",
    alpha = 0.9,
    border.col = "#0a0e27",
    lwd = 2,
    ...
    labels = c("0-10", "10-50", "50-100", "100-250", "250-500", "500-1000", "1000-2500", 
               paste0(">2500")),
...
tmap_save(
  map_geodetic,
  "output/05.Hexagon_Grid_flight_density_map.png",
  width = 18,
  height = 10,
  dpi = 400
)
